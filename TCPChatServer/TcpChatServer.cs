...
namespace TCPChatServer
{
    public class TcpChatServer
    {
        ...
        private readonly List<TcpClient> _viewers = new List<TcpClient>();
        private readonly List<TcpClient> _messengers = new List<TcpClient>();
        ...
        private void _checkForDisconnects()
        {
            ...
            foreach (TcpClient m in _messengers.ToArray())
            {
                if (_isDisconnected(m))
                {
                    ...
                    Console.WriteLine($"Messeger {name} has left.");
